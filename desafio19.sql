-- Desafio 19
-- Toda pessoa funcionária no banco hr possui um histórico completo de cargos. Logo, crie uma procedure chamada exibir_historico_completo_por_funcionario que,
--  dado o e-mail de uma pessoa funcionária,
...
-- 
-- Chamando-a dessa forma, sua procedure deve mostrar que a pessoa funcionária Neena Kochhar teve dois cargos em seu histórico: um como Accounting Manager no departamento Accounting e
--  o outro como Public Accountant no departamento Accounting, nessa ordem.
-- 
-- 
