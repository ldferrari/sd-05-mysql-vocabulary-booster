...
JOIN hr.jobs AS jbs ON empl.JOB_ID = jbs.JOB_ID -- relacionamento employees com jobs
JOIN hr.departments AS dpt ON empl.DEPARTMENT_ID = dpt.DEPARTMENT_ID -- relacionamento employees com departments
