-- Usando o banco hr como referência, queremos extrair informações a respeito dos 
-- salários das pessoas empregadas. Para isso, crie uma query que exiba três colunas:
-- A primeira coluna deve possuir o alias "Cargo" e exibir o nome do cargo.
-- A segunda coluna deve possuir o alias "Média salarial" e exibir a média dos 
...
-- Devido ao fato de a média salarial ser um valor monetário, sempre que for fazer 
-- uso da média salarial, é preciso arredondá-la usando apenas duas casas decimais.
