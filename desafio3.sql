...
-- A segunda coluna deve possuir o alias "Diferença entre salários máximo e mínimo" e 
-- exibir a diferença entre os salários máximo e mínimo para o cargo em questão.
