...
-- 
-- Logo, podemos dizer que João tem uma pessoa funcionária associada, Maria, que possui o mesmo cargo. Também podemos dizer que Maria tem uma pessoa funcionária associada, João, 
-- que possui o mesmo cargo. Já Alex não tem outra pessoa funcionária associada com o mesmo cargo. 
-- Portanto, seu relatório deveria ter dois resultados, um indicando que Maria tem uma pessoa associada João que possui o mesmo cargo, e o outro resultado indicando que João tem 
-- uma pessoa associada Maria que possui o mesmo cargo.
-- 
...
-- 
-- A quarta coluna deve possuir o alias "Nome completo funcionário 2" e exibir o nome completo da pessoa funcionária associada que possui o mesmo cargo (não se esqueça do espaço entre o nome e 
-- o sobrenome).
-- 
...
-- 
-- Os resultados devem estar ordenados pela coluna "Nome completo funcionário 1" em ordem alfabética. Em caso de empate, os resultados devem ser ordenados pela coluna 
-- Nome completo funcionário 2" em ordem alfabética.
...
-- CONCAT(e1.FIRST_NAME, ' ', e1.LAST_NAME) AS `Nome completo funcionário 
-- e1.SALARY AS 'Salário funcionário 1',
-- e1.PHONE_NUMBER AS 'Telefone funcionário 1'
